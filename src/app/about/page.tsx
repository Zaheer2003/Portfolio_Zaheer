...
export default function About() {
  ...
  return (
    <section className="min-h-screen px-4 py-16 bg-[#01003D] text-white font-audiowide">
      <div className="max-w-6xl mx-auto space-y-10">
        {/* Section Header */}
        <div className="text-center space-y-2">
          <h2 className="text-4xl font-bold">About Me</h2>
          <p className="text-white/70">Get to know me, my skills, and my journey in the world of technology</p>
        </div>

        <div className="grid md:grid-cols-2 gap-8">
          {/* Left - Who I Am */}
          <div className="bg-[#0D0D2B] p-6 rounded-xl border border-white/10 space-y-4">
            <h3 className="text-2xl font-semibold">Who I Am</h3>
            <p className="text-white/60 text-sm">A brief introduction</p>
            <p className="text-white/80 leading-relaxed text-base">
              Im a final-year Software Engineering student with a passion for building intelligent systems that solve real-world problems.
              My journey in tech has taken me from classroom theory to hands-on projects in AI, e-commerce, and user-focused software.
            </p>
            <p className="text-white/70 text-sm">
              I thrive at the intersection of creativity and problem-solving, with a goal of crafting modern digital solutions that are scalable, accessible, and intuitive.
            </p>
          ...
          <div className="bg-[#0D0D2B] p-6 rounded-xl border border-white/10">
